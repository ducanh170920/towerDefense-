...
public class TankerEnemy extends Enemy {
    ...
    public TankerEnemy (double x, int y) {
        ...
        this.imgTank = new ImageIcon(getClass().getResource("/Defaultsize/towerDefense_tile291.png")).getImage();
        this.direction = Direction.UP;
    }

    @Override
    public void setImgTank(Image imgtank) {
        super.setImgTank(imgtank);
